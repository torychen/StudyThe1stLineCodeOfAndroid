...
public class SampleGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        /* tory due to error Access denied finding property "ro.opengles.version"
        ...
        */
        ...
        //tory egl10.eglMakeCurrent(eglDisplay, eglSurfacePreview, eglSurfacePreview, eglContext);
        sampleGL20Video.draw();
    }
