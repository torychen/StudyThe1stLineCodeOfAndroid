 ...
 */
public  class BallSurfaceRenderer0 implements Runnable, SurfaceTexture.OnFrameAvailableListener{
    public static String LOG_TAG = BallSurfaceRenderer0.class.getSimpleName();
    public static String TAG = BallSurfaceRenderer0.class.getSimpleName();
    ...
    public BallSurfaceRenderer0(Context context, SurfaceTexture surfaceTexture, int width, int height) {
