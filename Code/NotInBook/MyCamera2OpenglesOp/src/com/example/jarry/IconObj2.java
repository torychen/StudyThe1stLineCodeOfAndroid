...
public class IconObj2 {
    ...
    Context context;
    public IconObj2(Context context){
        this.context=context;
        initBuffer();
        createProgram();
        textureId = initTexture(R.drawable.ic_launcher);
    ...
    protected void initBuffer(){
        ByteBuffer a=ByteBuffer.allocateDirect(sPos0.length*4);
        a.order(ByteOrder.nativeOrder());
        mVerBuffer=a.asFloatBuffer();
        mVerBuffer.put(sPos0);
